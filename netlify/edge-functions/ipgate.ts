    ...
    return new Response(
      `<!DOCTYPE html><html><head><title>Your IP — Skyform Portal</title>
       <style>
         ...
         .ip{font-size:32px;font-weight:700;color:#3fb950;margin:16px 0;word-break:break-all;padding:16px;background:#161b22;border:1px solid #30363d;border-radius:8px;}
       ...
       <body>
         <h1>Skyform Wind — Staging Portal</h1>
  ...
  if (!ALLOWED_IPS.includes(visitorIp)) {
    return new Response(
      `<!DOCTYPE html><html><head><title>Access Restricted — Skyform Portal</title>
       <style>
         body{font-family:"Segoe UI",Arial,sans-serif;padding:40px 24px;background:#0d1117;color:#e6edf3;max-width:500px;margin:0 auto;text-align:center;}
         ...
         .note{background:#2d1f1f;border:1px solid rgba(248,81,73,.3);border-radius:8px;padding:12px;margin-top:16px;font-size:12px;color:#f85149;}
       </style></head>
       <body>
         ...
         <div class="note">
           If your IP has recently changed, visit <a href="/my-ip">/my-ip</a> to confirm your current address and send it to your administrator.
         </div>
       </body></html>`,
